...
export function QuotePostCard({
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    if ((e.target as HTMLElement).closest("button, a, [role='menuitem'], .original-post-preview")) {
      return;
    }
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground">{quoter.handle}</span>
          ...
          <div 
            ...
            className="original-post-preview mt-3 cursor-pointer rounded-xl border border-border p-3 transition-colors hover:bg-muted/50"
          >
            <div className="flex items-center gap-2">
